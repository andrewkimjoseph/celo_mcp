...
For local write tools, add a funded wallet:
...
Use testnet keys only for demos. The server decrypts the key ephemerally to sign the transaction — it is not stored.
